...
class Item(models.Model):
    ...
    dinner_image_url = models.TextField(blank=True, null=True)
    lunch_image_url = models.TextField(blank=True, null=True)
...
#     def get_purchased_items(self) -> typing.Iterable[PurchasedItem]:
